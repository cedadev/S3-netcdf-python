...
cdef class CFAVariable:
    ...
    def __getitem__(CFAVariable self, in_key):
        ...
        for i in part_index_list:
            partition = self.getPartition(i, slices)
    ...
    cpdef object getPartition(CFAVariable self, index, slices=None):
                ...
                if slices is not None:
                    ...
                    for d in range(0, n_dims):
                        while True:
                            ...
                            p_shape = ncp.variables["shape"][current_index]
